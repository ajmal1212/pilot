<template>
  <div class="mx-auto max-w-2xl p-4 sm:p-6">
    <div class="flex justify-between items-center mb-6">
      <h1 class="font-medium text-ink-gray-8 text-base">Deployment Configurations</h1>
    </div>
    ...
    <div v-else class="flex flex-col gap-6">
      ...
      <div class="bg-surface-elevation-1 p-5 border rounded-xl border-outline-gray-2 flex flex-col gap-4">
        <div class="flex items-center justify-between">
          <div class="flex flex-col gap-0.5">
            ...
            <p class="text-ink-gray-5 text-p-sm">Expose local services securely without public IP addresses.</p>
          </div>
          <Badge
      ...
      <div class="bg-surface-elevation-1 p-5 border rounded-xl border-outline-gray-2 flex flex-col gap-6">
        <div class="flex flex-col gap-0.5">
          ...
          <p class="text-ink-gray-5 text-p-sm">Configure an existing tunnel or create a new one automatically.</p>
        </div>
        ...
        <!-- Form: Create New -->
        <div v-slot="setupType === 'create'" v-if="setupType === 'create'" class="flex flex-col gap-4">
          <Password
...
setBreadcrumbs([{ label: 'Deployment', route: { name: 'Deployment' } }])
