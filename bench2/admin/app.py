...
from bench2.admin.views.apps import apps_bp
from bench2.admin.views.dashboard import dashboard_bp
from bench2.admin.views.database import database_bp
from bench2.admin.views.logs import logs_bp
from bench2.admin.views.processes import processes_bp
from bench2.admin.views.sites import sites_bp
from bench2.admin.views.tasks import tasks_bp
